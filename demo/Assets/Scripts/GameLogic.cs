...
public class GameLogic : MonoBehaviour
{
    ...
    //Text
    public TextMeshProUGUI trialInfo;
    ...
    void Start()
    {
        ...
        //Text:
        trialInfo.text = "Trial Number: " + trialNumber.ToString();
    }
    ...
    void Update()
    {
        ...
        {
            //Make opaque
            setObjectColor(waypointMeshRenderer, 0.5f, 0.5f, 0.0f, 0.0f);
        }
        else
        {
            //Keep translucent
           ...
           Vector3 penetration, Vector3 penetrationDirection, bool contactBoolean, LineRenderer lineRenderer, Color lineColor)
    {
        ...
        else
        {
            ...
            totalForceVal = penetrationForce;
        }
        ...
        drawFingerForceVector(totalForceVal, fingerCubeVec, 0.5f * cubeLength, 0.01f, lineRenderer, lineColor);
