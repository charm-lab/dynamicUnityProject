...
/*
File Name: WhyskerBLETest1.CS
Author: Triton Systems -- modified from Adabru 
Purpose: Creates and maintans connection with WHYSKER.  Uses WhyskerBle. No Longer in Use. 
Last Modification: 6/29/2021 -- Added Documentation Header
*/


// This Script is for testing UWP + BLE On PC comms
public class WhyskerBLETest1 : MonoBehaviour
{
...
//    public Text errorText;
    ...
    WhyskerBLE whyskerBle = new WhyskerBLE();
...
//        Array.Reverse(payload);
        ...
        data.serviceUuid = whyskerBle.getService("led");
        data.characteristicUuid = whyskerBle.getChar("led");
...
//        #endif 
    ...
    public void WriteMotor(){
        ...
        data.size = (short)payload.Length;
        data.deviceId = selectedDeviceId;
        data.serviceUuid = whyskerBle.getService("motor");
        data.characteristicUuid = whyskerBle.getChar("motor");
