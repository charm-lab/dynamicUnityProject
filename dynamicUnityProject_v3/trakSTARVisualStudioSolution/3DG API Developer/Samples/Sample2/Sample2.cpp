...
int main(int argc, char* argv[])
{
	...
	// MEASUREMENT_RATE
	//
	double newMeasurementRate = originalMeasurementRate - 5;
	{
		double buffer = newMeasurementRate;  // Set the rate for 5Hz less
		double *pBuffer = &buffer;
		printf("MEASUREMENT_RATE: %5.2f\n", buffer);
	...
	printf("MEASUREMENT_RATE:       %.1d\n", newMeasurementRate);
	SET_SYSTEM_PARAMETER(MEASUREMENT_RATE,		newMeasurementRate);
	...
	//
	char *savePath = ".\\sample2config.ini";
